...
(Drupal => {
  /**
   * IslandoraIROlivero helper functions.
   *
   * @namespace
   */
  ...
  document.addEventListener('keyup', e => {
    if (e.keyCode === 27) {
      ...
      if (
        'toggleSearchVisibility' in Drupal.islandorairolivero &&
        'searchIsVisible' in Drupal.islandorairolivero &&
        Drupal.islandorairolivero.searchIsVisible()
      ) {
