(Drupal => {
  const { isDesktopNav } = Drupal.islandorairolivero;
  ...
  Drupal.islandorairolivero.toggleSubNav = toggleSubNav;
  ...
  Drupal.islandorairolivero.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.islandorairolivero.areAnySubNavsOpen = areAnySubNavsOpen;
