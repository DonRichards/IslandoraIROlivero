...
namespace Drupal\islandorairolivero;

use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the IslandoraIROlivero theme.
 *
 * @internal
 */
class IslandoraIROliveroPreRender implements TrustedCallbackInterface {
